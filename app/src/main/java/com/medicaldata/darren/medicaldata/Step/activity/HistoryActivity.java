...
import com.medicaldata.darren.medicaldata.Step.adapter.CommonAdapter;
import com.medicaldata.darren.medicaldata.Step.adapter.CommonViewHolder;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.step_ac_history);
        assignViews();
