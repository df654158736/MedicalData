...
public class ChartDataBean {
    ...
    public float SpendHour;
    public int Waist;
    public float TwelveMinuteDistance;
    public int BenchPress;
    public int DriveLeg;
    public int Pushup;
    public int ShoulderFlexion;
    public int SitAnterior;
    public int YMCABenchPress;
    public int YMCASitAnterior;
